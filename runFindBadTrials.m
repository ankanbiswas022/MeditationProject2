...
saveDataFlag = 1;
badTrialNameStrS = {'_d4020_v10'}; % with the 5 deg window
...
for b = 1:length(badTrialNameStrS)
    ...
    for i=1:length(segmentTheseIndices)
        ...
        for j=1:length(protocolNameList)
            ...
            findBadTrialsWithEEG_v10(subjectName,expDate,protocolName,folderSourceString,gridType,badEEGElectrodes,...
