...
i=18; subjectNames{i} = '019CK';      expDates{i} = '230222';  % Have shorter duration
...
i=21; subjectNames{i} = '023PM';      expDates{i} = '230322';  % 
i=22; subjectNames{i} = '024SK';      expDates{i} = '240322';  % Special case: G2 ran for 180 trials, should be 120 trials
i=23; subjectNames{i} = '025RK';      expDates{i} = '250322';  % 
i=24; subjectNames{i} = '026HM';      expDates{i} = '300322';  % 
i=25; subjectNames{i} = '027SM';      expDates{i} = '310322';  % 
%-----------------------------------------------------------------------------------------------------
i=26; subjectNames{i} = '019CKa';     expDates{i} = '030422';  % 
i=27; subjectNames{i} = '028HB';      expDates{i} = '050422';  % 
...
i=33; subjectNames{i} = '033PJ';      expDates{i} = '120422';  % 
i=34; subjectNames{i} = '034TG';      expDates{i} = '130422';  % 
i=35; subjectNames{i} = '035SS';      expDates{i} = '160422';  % Error in EC2, 105 line 
...
i=42; subjectNames{i} = '045SP';      expDates{i} = '100522';  % 
