...
subjectNameGrouped{8,1}  = '053DR';   subjectNameGrouped{8,2} = '063VK'; % A-43, C-43

% Male 45-49 (2 matched)
subjectNameGrouped{9,1}  = '045SP';   subjectNameGrouped{9,2} = '078BM'; % A-47, C-48
subjectNameGrouped{10,1} = '025RK';  subjectNameGrouped{10,2} = '070TB'; % A-49, C-49

% Male 50-59 (2 matched, 1 C54 required)
subjectNameGrouped{11,1} = '035SS'; subjectNameGrouped{11,2} = '080RP'; % A-50, C-50
subjectNameGrouped{12,1} = '010AK'; subjectNameGrouped{12,2} = '069MG'; % A-54, C-55
% subjectNameGrouped{13,1} = '044PN'; subjectNameGrouped{13,2} = '*'; 	  % A-54, C-

% Male 60-65 (1 matched, 1 A61 required)
subjectNameGrouped{13,1} = '046ME'; subjectNameGrouped{13,2} = '068RV'; % A-62, C-61
...
subjectNameGrouped{14,1} = '031BK'; subjectNameGrouped{14,2} = '081SN'; % A-24, C-23
subjectNameGrouped{15,1} = '056PR'; subjectNameGrouped{15,2} = '073SK'; % A-27, C-26
% subjectNameGrouped{3,3} = '*'; 	subjectNameGrouped{3,4} = '086AB'; % *A-28, C-28

% Female 30-39 (3 matched, 1 C34 required)
subjectNameGrouped{16,1} = '052PR'; subjectNameGrouped{16,2} = '087KR'; % A-31,  C-31, %[C-31 '082MS']
% subjectNameGrouped{5,3} = '059MS'; subjectNameGrouped{5,4} = '*'; 	% A-34, *C-34
subjectNameGrouped{17,1} = '013AR'; subjectNameGrouped{17,2} = '064PK'; % A-35,  C-35 
subjectNameGrouped{18,1} = '074KS'; subjectNameGrouped{18,2} = '084AK'; % A-36,  C-37

% Female 40-44 (1 matched,  required A42)
% *Note: This change was made based on the subject availability 
subjectNameGrouped{19,1} = '006SR'; subjectNameGrouped{19,2} = '088SP'; %  A-40, C-39
% subjectNameGrouped{9,3} = '*'; 	subjectNameGrouped{9,4} = '062MT'; % *A-42, C-42

% Female 45-49  (2 matched)
subjectNameGrouped{20,1}  = '036MS';  subjectNameGrouped{20,2}  = '049KK';  % A-47, C-46
subjectNameGrouped{21,1}  = '017KG';  subjectNameGrouped{22,2} = '072DK';  % A-49, C-49
...
subjectNameGrouped{22,1} = '050UR'; subjectNameGrouped{22,2} = '083SP'; % A-53,  C-53
subjectNameGrouped{23,1} = '030SH'; subjectNameGrouped{23,2} = '076BH'; % A-56,  C-56

% Female 60-65 (1 matched with +/-2)
subjectNameGrouped{24,1} = '089AB'; subjectNameGrouped{24,2} = '079SG'; % A-64, C-62
